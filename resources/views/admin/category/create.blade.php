                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category#create')}}" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="categoryName" name="categoryName" type="text" value="{{ old('categoryName') }}" class="form-control @error('categoryName') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Category Name...">
                                    @error('categoryName')
